...
use genetic_algorithm::genotype::{
    Genotype, HillClimbGenotype, MultiRangeGenotype, MutationType, PermutateGenotype,
...
fn float_mutate_chromosome_single_range_scaled() {
    ...
    let mut genotype = MultiRangeGenotype::builder()
        .with_allele_ranges(vec![0.0..=1.0, 0.0..=5.0, 10.0..=20.0])
        .with_mutation_types(vec![
            MutationType::RangeScaled(vec![0.5, 0.1, 0.01]),
            MutationType::RangeScaled(vec![1.0, 0.5, 0.05]),
            MutationType::RangeScaled(vec![5.0, 1.0, 0.1]),
        ])
        .build()
        .unwrap();
...
fn float_mutate_chromosome_single_step() {
    ...
    let genotype = MultiRangeGenotype::builder()
        .with_allele_ranges(vec![0.0..=1.0, 0.0..=5.0, 10.0..=20.0])
        .with_mutation_types(vec![
            MutationType::Step(0.5),
            MutationType::Step(1.0),
            MutationType::Step(5.0),
        ])
        .build()
        .unwrap();
...
fn float_mutate_chromosome_single_step_scaled() {
    ...
    let mut genotype = MultiRangeGenotype::builder()
        ...
        .with_mutation_types(vec![
            ...
            MutationType::StepScaled(vec![1.0, 0.5, 0.05]),
...
fn float_neighbouring_population_1() {
    ...
    let genotype = MultiRangeGenotype::builder()
        ...
        .with_mutation_types(vec![MutationType::Range(0.1)])
        .build()
        .unwrap();
...
#[test]
fn float_neighbouring_population_3_range() {
    let mut rng = SmallRng::seed_from_u64(0);
    let genotype = MultiRangeGenotype::builder()
        .with_allele_ranges(vec![0.0..=1.0, 0.0..=5.0, 10.0..=20.0])
        .with_mutation_types(vec![
    ...
    assert!(relative_population_eq(
        inspect::population(&population),
        vec![
            vec![0.401, 2.195, 19.798],
            vec![0.493, 2.195, 19.798],
            vec![0.447, 1.747, 19.798],
            vec![0.447, 2.644, 19.798],
            vec![0.447, 2.195, 18.855],
...
#[test]
fn float_neighbouring_population_3_step_scaled() {
    let mut rng = SmallRng::seed_from_u64(0);
    let mut genotype = MultiRangeGenotype::builder()
        .with_allele_ranges(vec![0.0..=1.0, 0.0..=5.0, 10.0..=20.0])
        .with_mutation_types(vec![
...
#[test]
fn float_neighbouring_population_3_discrete() {
    let mut rng = SmallRng::seed_from_u64(0);
    let mut genotype = MultiRangeGenotype::builder()
...
#[test]
fn float_permutable_gene_values_discrete() {
    let mut rng = SmallRng::seed_from_u64(0);
    let genotype = MultiRangeGenotype::builder()
        .with_allele_ranges(vec![0.0..=3.0, -2.0..=5.0])
    ...
    assert!(relative_chromosome_eq(
        genotype.permutable_gene_values_discrete(0, Some(&chromosome)),
        vec![0.0, 1.0, 2.0, 3.0],
        0.001
    ));
    assert!(relative_chromosome_eq(
        genotype.permutable_gene_values_discrete(1, Some(&chromosome)),
...
fn float_chromosome_permutations_2_step_scaled() {
    ...
    let mut genotype = MultiRangeGenotype::builder()
        .with_allele_ranges(vec![0.0..=10.0, 0.0..=5.0])
        .with_mutation_types(vec![
            MutationType::StepScaled(vec![5.0, 2.5, 1.0]),
            MutationType::StepScaled(vec![3.0, 1.5, 1.0]),
        ])
        .build()
        .unwrap();
...
#[test]
fn integer_mutate_chromosome_single_discrete() {
    let mut rng = SmallRng::seed_from_u64(0);
    let genotype = MultiRangeGenotype::builder()
        .with_allele_ranges(vec![0..=9, 0..=5, 10..=20])
        .with_mutation_types(vec![
...
fn integer_neighbouring_population_1() {
    ...
    let genotype = MultiRangeGenotype::builder()
        ...
        .with_mutation_types(vec![MutationType::Range(1)])
        .build()
        .unwrap();
...
#[test]
fn integer_neighbouring_population_3_range() {
    let mut rng = SmallRng::seed_from_u64(0);
    let genotype = MultiRangeGenotype::builder()
        .with_allele_ranges(vec![0..=9, 0..=5, 10..=20])
        .with_mutation_types(vec![
...
#[test]
fn integer_neighbouring_population_3_discrete() {
    let mut rng = SmallRng::seed_from_u64(0);
    let genotype = MultiRangeGenotype::builder()
        .with_allele_ranges(vec![0..=9, 0..=5, 10..=12])
        .with_mutation_types(vec![
            MutationType::Range(4),
            MutationType::Discrete,
            MutationType::Discrete,
        ])
        .build()
    ...
    let chromosome = Chromosome::new(genotype.random_genes_factory(&mut rng));
    assert_eq!(inspect::chromosome(&chromosome), vec![4, 2, 12]);
