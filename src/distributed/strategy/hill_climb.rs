...
pub use crate::distributed::strategy::reporter::Duration as HillClimbReporterDuration;
pub use crate::distributed::strategy::reporter::Noop as HillClimbReporterNoop;
...
/// use genetic_algorithm::distributed::fitness::placeholders::SumGenes;
///
/// // the search space
