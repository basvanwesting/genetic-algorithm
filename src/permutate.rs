...
pub struct Permutate<T: Gene, G: Genotype<T>, F: Fitness<T>> {
    pub genotype: G,
...
impl<T: Gene, G: Genotype<T>, F: Fitness<T>> Permutate<T, G, F> {
...
impl<T: Gene, G: Genotype<T>, F: Fitness<T>> fmt::Display for Permutate<T, G, F> {
