...
//!     .with_select(SelectElite::new(0.02))                        // (E) sort the chromosomes by fitness to determine crossover order and drop excess population above target_population_size
