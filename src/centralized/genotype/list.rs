...
use crate::centralized::chromosome::{ChromosomeManager, GenesHash, GenesOwner, ListChromosome};
...
/// ```
/// use genetic_algorithm::centralized::genotype::{Genotype, ListGenotype};
///
...
/// # Example (struct)
/// ```
/// use genetic_algorithm::centralized::genotype::{Allele, Genotype, ListGenotype};
///
