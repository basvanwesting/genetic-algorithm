...
use crate::centralized::chromosome::{BinaryChromosome, ChromosomeManager, GenesHash, GenesOwner};
...
/// # Example:
/// ```
/// use genetic_algorithm::centralized::genotype::{Genotype, BinaryGenotype};
///
