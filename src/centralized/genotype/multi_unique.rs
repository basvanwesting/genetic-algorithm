...
use crate::centralized::chromosome::{
    ChromosomeManager, GenesHash, GenesOwner, MultiUniqueChromosome,
};
...
/// ```
/// use genetic_algorithm::centralized::genotype::{Genotype, MultiUniqueGenotype};
///
...
/// ```
/// use genetic_algorithm::centralized::genotype::{Allele, Genotype, MultiUniqueGenotype};
///
