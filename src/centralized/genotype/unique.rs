...
use crate::centralized::chromosome::{ChromosomeManager, GenesHash, GenesOwner, UniqueChromosome};
...
/// ```
/// use genetic_algorithm::centralized::genotype::{Genotype, UniqueGenotype};
///
...
/// # Example (struct)
/// ```
/// use genetic_algorithm::centralized::genotype::{Allele, Genotype, UniqueGenotype};
///
