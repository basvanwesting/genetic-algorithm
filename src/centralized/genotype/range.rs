...
use crate::centralized::chromosome::{ChromosomeManager, GenesHash, GenesOwner, RangeChromosome};
...
/// # Example (f32, default):
/// ```
/// use genetic_algorithm::centralized::genotype::{Genotype, RangeGenotype};
///
